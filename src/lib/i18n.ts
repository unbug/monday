...
const agentPanel: Record<Locale, Record<string, string>> = {
  en: {
    ...
    'asyncTask.title': 'Async Task Queue',
    'asyncTask.goalPlaceholder': 'Describe the task you want the agent to execute...',
    'asyncTask.briefLabel': 'Task brief (optional)',
    'asyncTask.noBrief': 'None',
    'asyncTask.submit': '🚀 Delegate',
    'asyncTask.pending': 'Pending',
    'asyncTask.running': 'Running',
    'asyncTask.done': 'Done',
    'asyncTask.error': 'Error',
    'asyncTask.cancelled': 'Cancelled',
    'asyncTask.needsInput': 'Needs Input',
    'asyncTask.empty': 'No tasks yet. Submit a task above to delegate to the agent.',
    'asyncTask.goal': 'Goal',
    'asyncTask.steps': 'Steps',
    'asyncTask.result': 'Result',
    'asyncTask.cancel': 'Cancel',
    'asyncTask.delete': 'Delete',
    'asyncTask.justNow': 'now',
  },
  zh: {
    ...
    'asyncTask.title': '异步任务队列',
    'asyncTask.goalPlaceholder': '描述你想要 Agent 执行的任务...',
    'asyncTask.briefLabel': '任务简报（可选）',
    'asyncTask.noBrief': '无',
    'asyncTask.submit': '🚀 委托',
    'asyncTask.pending': '等待中',
    'asyncTask.running': '运行中',
    'asyncTask.done': '已完成',
    'asyncTask.error': '错误',
    'asyncTask.cancelled': '已取消',
    'asyncTask.needsInput': '需要输入',
    'asyncTask.empty': '暂无任务。在上方提交任务委托给 Agent。',
    'asyncTask.goal': '目标',
    'asyncTask.steps': '步骤',
    'asyncTask.result': '结果',
    'asyncTask.cancel': '取消',
    'asyncTask.delete': '删除',
    'asyncTask.justNow': '刚刚',
  },
}
