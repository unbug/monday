...
const agentPanel: Record<Locale, Record<string, string>> = {
  en: {
    ...
    'agent.loopTitle': 'Sandboxed Agent Loop',
    'agent.loopSubtitle': 'Generate → render → screenshot → iterate',
    'agent.loopGoal': 'Task Goal',
    'agent.loopGoalPlaceholder': 'Describe what the agent should accomplish...',
    'agent.loopStart': 'Start Loop',
    'agent.loopStop': 'Stop',
    'agent.loopRefresh': 'Refresh',
    'agent.loopAutoRefresh': 'Auto-refresh',
    'agent.loopClear': 'Clear',
    'agent.loopIterations': 'Iterations',
    'agent.loopLastScreenshot': 'Last screenshot',
    'agent.loopError': 'Error',
    'agent.loopPreview': 'Sandboxed Preview',
    'agent.loopShowPreview': 'Show Preview',
    'agent.loopHtmlSource': 'HTML Source',
    'agent.loopTruncated': 'truncated',
    'agent.loopDomState': 'DOM State',
    'agent.loopScreenshot': 'Screenshot',
    'agent.loopHistory': 'Iteration History',
    'agent.loopSteps': 'Agent Steps',
    'agent.back': 'Back',
    'agent.justNow': 'just now',
    // Task brief (v1.3)
    'taskBrief.title': 'Task Brief',
    'taskBrief.selectorLabel': 'Brief:',
    'taskBrief.none': 'None',
    'taskBrief.create': 'New',
    'taskBrief.edit': 'Edit',
    'taskBrief.delete': 'Delete',
    'taskBrief.save': 'Save',
    'taskBrief.cancel': 'Cancel',
    'taskBrief.newBrief': 'New Brief',
    'taskBrief.untitled': 'Untitled',
    'taskBrief.defaultBrief': 'Default Brief',
    'taskBrief.namePlaceholder': 'Brief name',
    'taskBrief.contentPlaceholder': 'Write your task brief here...\n\n# Goal\nDescribe what the agent should accomplish.\n\n# Allowed Domains\n- list of allowed domains\n\n# Step Budget\nMaximum steps: 20\n\n# Stop Criteria\n- Condition 1\n- Condition 2',
  ...
  zh: {
    ...
    'agent.noArgs': '（无参数）',
    'agent.loopTitle': '沙盒 Agent 循环',
    'agent.loopSubtitle': '生成 → 渲染 → 截图 → 迭代',
    'agent.loopGoal': '任务目标',
    'agent.loopGoalPlaceholder': '描述 Agent 应该完成的任务...',
    'agent.loopStart': '启动循环',
    'agent.loopRefresh': '刷新',
    'agent.loopAutoRefresh': '自动刷新',
    'agent.loopClear': '清除',
    'agent.loopIterations': '迭代次数',
    'agent.loopLastScreenshot': '上次截图',
    'agent.loopError': '错误',
    'agent.loopPreview': '沙盒预览',
    'agent.loopShowPreview': '显示预览',
    'agent.loopHtmlSource': 'HTML 源码',
    'agent.loopTruncated': '已截断',
    'agent.loopDomState': 'DOM 状态',
    'agent.loopScreenshot': '截图',
    'agent.loopHistory': '迭代历史',
    'agent.loopSteps': 'Agent 步骤',
    'agent.back': '返回',
    'agent.justNow': '刚刚',
    // Task brief (v1.3)
    'taskBrief.title': '任务简报',
    'taskBrief.selectorLabel': '简报:',
    'taskBrief.none': '无',
    'taskBrief.create': '新建',
    'taskBrief.edit': '编辑',
    'taskBrief.delete': '删除',
    'taskBrief.save': '保存',
    'taskBrief.cancel': '取消',
    'taskBrief.newBrief': '新简报',
    'taskBrief.untitled': '未命名',
    'taskBrief.defaultBrief': '默认简报',
    'taskBrief.namePlaceholder': '简报名称',
    'taskBrief.contentPlaceholder': '在此编写任务简报...\n\n# 目标\n描述代理应完成的任务。\n\n# 允许域名\n- 允许访问的域名列表\n\n# 步骤预算\n最大步骤数: 20\n\n# 停止条件\n- 条件 1\n- 条件 2',
    'agent.visionMode': '视觉',
